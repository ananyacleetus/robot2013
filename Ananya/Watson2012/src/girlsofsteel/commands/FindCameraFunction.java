...
public class FindCameraFunction extends CommandBase {
    ...
    protected void initialize() {
        ...
        System.out.println("data collection done! cnt=" + CameraAuto.NumberOfCameraDataPoints);
        double[] ab = LinearRegression.bestFit(CameraAuto.imageTargetRatioData, CameraAuto.distanceData, CameraAuto.NumberOfCameraDataPoints);
        double a = ab[0];
        double b = ab[1];
