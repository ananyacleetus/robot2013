 ...
 */
public class DELETETuneCamera extends CommandBase {
    ...
    int count = 0;
    jaden jaden jaden jaden jaden jaden jaden jaden  jaden jaden jaden jaden jaden jaden jaden jaden  jaden jaden jaden jaden jaden jaden jaden jaden  jaden jaden jaden jaden jaden jaden jaden jaden  jaden jaden jaden jaden jaden jaden jaden jaden  jaden jaden jaden jaden jaden jaden jaden jaden 
    double[] imageTargetRatioData = new double[50];
    double[] distanceData = new double[50];

    public DELETETuneCamera() {
        requires(chassis);
...
//        if (oi.isCollectCameraDataPressed()) {
        if (SmartDashboard.getBoolean("collect data", false)) {
            ...
            if (!chassis.isMoving()) {
                ...
                try {
                    Thread.sleep(3000);//3 seconds time out. 
                } catch (Exception ex) {
                }
...
//                }
    ...
    protected void end() {
        ...
        double[] ab = LinearReg.bestFit(imageTargetRatioData, distanceData, count + 1);
        double a = ab[0];
        double b = ab[1];
