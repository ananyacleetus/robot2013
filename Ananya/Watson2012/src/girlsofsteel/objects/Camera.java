...
public class Camera {
    ...
    public static double getXDistance(){ //distance from the camera to the backboard.
        double xDistance;
        xDistance = NetworkTable.getTable("camera").getDouble("distanceToBottomTarget", 0)*(0.0254/1.0);
        return xDistance;
    }
